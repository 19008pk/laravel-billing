                ...
                <form action="{{ route('units.update', $unit->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="short_code"
                            class="block text-gray-700 dark:text-gray-300">{{ __('Short Code') }}</label>
                        <input type="text" name="short_code" id="short_code" value="{{ $unit->short_code }}"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    </div>
                    <div class="mb-4">
                        <label for="description"
                            class="block text-gray-700 dark:text-gray-300">{{ __('Description') }}</label>
